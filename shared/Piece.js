export default class Piece
{
    ...
    collide(board, playerPos, ownPos, dir){
        ...
        {
            //Eat and win
            mutation.push(this.muta_gen("moved", playerPos, ownPos));
            mutation.push(this.muta_gen("win", null, null, null, null, null, true));
        }else if(this.type === "Death Goal")
        {
            //Eat and loose
            mutation.push(this.muta_gen("moved", playerPos, ownPos));
            mutation.push(this.muta_gen("win", null, null, null, null, null, false));
        }else if(this.type === "Sunflower")
        {
            //eat and increment score, arbitrarily set to 10
            mutation.push(this.muta_gen("moved", playerPos, ownPos));
            mutation.push(this.muta_gen("increment", null, null, null, null, 10));
        }else if(this.type === "Treasure Chest")
        {
            //eat and increment score, arbitrarily set to 50
            mutation.push(this.muta_gen("moved", playerPos, ownPos));
            mutation.push(this.muta_gen("increment", null, null, null, null, 50));
        ...
        }else if(this.type === "Key")
        {
            ...
            if(board[playerPos[0]][playerPos[1]].inventory.has("Key") ){
                ...
                board[playerPos[0]][playerPos[1]].inventory.add("Key");
                mutation.push(this.muta_gen("moved", playerPos, ownPos));
            }
        }else if(this.type === "Gate")
        {
            ...
            if(board[playerPos[0]][playerPos[1]].inventory.has("Key") ){
                mutation.push(this.muta_gen("moved", playerPos, ownPos));
                board[playerPos[0]][playerPos[1]].inventory.delete("Key");
            }else{
                return null;
            }
        }
    ...
    muta_gen(type, old_loc, new_loc, loc, new_piece, score, bool, inven){
        const muta = new Object();
        muta.type = type;
        if(type === "moved"){
            muta.old = old_loc;
            muta.new = new_loc;
